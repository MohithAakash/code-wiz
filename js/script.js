    ...
    * @description  toggle swiper videos on active slides
                ...
                .swiper({
                    ...
                    onInit: function (swiper) {
                        if (plugins.pageLoader.length) {
                            var srcFirst =
                                    $("#page-loader").attr("data-slide-bg"),
                    ...
                    if (!circleProgressItem.hasClass("animated")) {
                        ...
                        circleProgressItem
                            .circleProgress({
                                ...
                                emptyFill: circleProgressItem.attr(
                                    "data-empty-fill"
                                )
                                    ? circleProgressItem.attr("data-empty-fill")
                                    : "rgb(245,245,245)",
                                thickness: circleProgressItem.attr(
                                    "data-thickness"
                                )
                                    ? parseInt(
                                          circleProgressItem.attr(
                                              "data-thickness"
                                          )
                                      )
                                    : 4,
    ...
    if (plugins.responsiveTabs.length) {
        ...
        for (i = 0; i < plugins.responsiveTabs.length; i++) {
            ...
            $this.easyResponsiveTabs({
                ...
                tabidentify:
                    $this.find(".resp-tabs-list").attr("data-group") || "tab",
            });
        }
        if ($(".tabs-nav").length) {
                ...
                callbacks: {
                    postsLoaded: function () {
                        ...
                        for (i = 0; i < posts.length; i++) {
                            ...
                            if (
                                commentBlock.find("[data-fb-comment]").length ==
                                0
                            ) {
                                commentBlock.remove();
                            }
    ...
    if (plugins.bootstrapDateTimePicker.length) {
        ...
        for (i = 0; i < plugins.bootstrapDateTimePicker.length; i++) {
            ...
            options["time"] =
                $dateTimePicker.attr("date-time-picker") != "date";
            options["date"] =
                $dateTimePicker.attr("date-time-picker") != "time";
            ...
            $slickItem
                .slick({
                    ...
                    centerPadding: $slickItem.attr("data-center-padding")
                        ...
                        : "0.50",
                    mobileFirst: true,
                    fade: $slickItem.attr("data-fade")
                        ? $slickItem.attr("data-fade")
                        : false,
                    responsive: [
                        {
                            breakpoint: 0,
                            settings: {
                                slidesToShow:
                                    parseInt($slickItem.attr("data-items")) ||
                                    1,
                            },
                        },
                        {
